...
create table if not exists users (
    ...
    foreign key(details) references user_details(detail_id)
);
...
insert into user_details values (1, 'Evgenii', 'Bai', 'evgenii.bai@decathlon.com', '9135082020');
insert into users values (1, '00000010-d729-4c52-ab29-b4dba065d2a7', 'admin', '{noop}admin', 1, 'ADMIN', 'ACTIVE');
